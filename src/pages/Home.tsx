...
function HeroStat({ value, label }: { value: string; label: string }) {
  return <div className="flex min-h-[72px] flex-col justify-center rounded-2xl border border-[#16A34A]/25 bg-white px-2 py-3 text-center shadow-[0_10px_24px_rgba(22,163,74,.14)]"><p className="font-display text-xl font-extrabold leading-none text-[#16A34A] sm:text-2xl">{value}</p><p className="mt-2 truncate text-[10px] font-semibold text-ink/70 sm:text-xs">{label}</p></div>;
}
